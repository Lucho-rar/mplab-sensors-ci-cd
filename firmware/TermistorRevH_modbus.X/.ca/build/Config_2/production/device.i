...
void getDeviceAddress(sensor_info_t* sensor_info)
{
    sensor_info->address[0] = "001"[0];
 sensor_info->address[1] = "001"[1];
    sensor_info->address[2] = "001"[2];
}
...
void sendSensorData(uint16_t sensor_data)
{
    ...
    packet.crc8 = crc8(&packet.value,5);

    packet.end = '\n';

    sendPacket((char*)&packet, sizeof(data_packet_t));
}
# 57 "device.c"
int stringCompare(const char* str, const char* buf, int byte_count)
{
