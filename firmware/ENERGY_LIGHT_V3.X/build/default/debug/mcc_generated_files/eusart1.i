...
uint8_t EUSART1_Read(void)
{
    ...
    while(!(eusart1RxHead != eusart1RxTail));

    readValue = eusart1RxBuffer[eusart1RxTail];
    eusart1RxTail = (eusart1RxTail + 1) % 64;
...
void EUSART1_RxDataHandler(void){
    ...
    if(eusart1RxBuffer[eusart1RxHead])
    {
        if(eusart1RxBuffer[eusart1RxHead] == 0x0A)
        {
            eusart1PacketFinish++;
        }
        t=eusart1RxHead;
        eusart1RxHead = (eusart1RxHead + 1)% 64;
