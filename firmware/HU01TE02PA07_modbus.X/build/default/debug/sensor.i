...
# 134 "./mcc_generated_files/examples/i2c1_master_example.h"
uint8_t BuffReg[8];
...
uint8_t readBMP280(uint8_t regadd)
{
    ...
    pRxbuffer = &ret;
    pTxbuffer = &regadd;
    I2C1_WriteNBytes(0x76,pTxbuffer,1);
    I2C1_ReadNBytes(0x76,pRxbuffer,1);
    return ret;
}
...
void writeBMP280(uint8_t regadd, uint8_t regdata)
{
    ...
    I2C1_WriteNBytes(0x76,pTxbuffer,2);
}

void InitBMP280(void)
{
    writeBMP280(0xF5,0x00);
    writeBMP280(0xF4,0xFC);
}
...
uint24_t getBMP280Data(ParamDPS422_t param)
{
    ...
    if(param == TEMP) Txbuffer = 0xFA;
    else if(param == PRES)Txbuffer = 0xF7;
...
void InitDPS422(void)
{
    ...
    writeDPS422(0x06,0x00);
    writeDPS422(0x07,0x00);
}
...
int24_t getDPS422Data(ParamDPS422_t param)
{
    ...
    writeDPS422(0x08,0x03);

    if(param == TEMP) Txbuffer = 0x03;
    else if(param == PRES)Txbuffer = 0x00;
...
uint16_t getSHTC3Data(void)
{
    ...
    Txbuffer[1] = 0x17;
    pbuffer = &Txbuffer[0];
    I2C1_WriteNBytes(0x70,pbuffer,2);
    ...
    pbuffer = &Rxbuffer[0];
    I2C1_ReadNBytes(0x70,pbuffer,2);
