...
void default_values_register(mod_bus_registers* registers)
{
    registers->server_holding_register.addr_slave = 3;
    ...
    registers->server_input_register.serial_number = 1;
    registers->server_input_register.sensor_type = 200;
    readBMP280coeff(registers->server_input_register.coeff);
}
