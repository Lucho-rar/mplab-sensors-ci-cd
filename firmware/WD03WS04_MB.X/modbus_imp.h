...
#define COILS_ADDR_MAX              3
#define REGS_INPUT_ADDR_MAX         4
#define REGS_HOLDING_ADDR_MAX       2

// Our RTU address
#define RTU_SERVER_ADDRESS_DEFAULT  1
#define RTU_BAUDRATE_DEFAULT        9600
    
#define RTU_SERIAL_NUMBER_DEFAULT   666
#define RTU_SENSOR_TYPE_DEFAULT     999
