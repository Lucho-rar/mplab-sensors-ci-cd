...
#define DEVICE_ADDRESS1     "003"    // Device specific address (0-255)
#define DEVICE_CODENAME1	"WD003"//
/****************** Device 2 specific parameters ******************************/    
#define DEVICE_ADDRESS2     "004"    // Device specific address (0-255)
#define DEVICE_CODENAME2	"WS004"//
