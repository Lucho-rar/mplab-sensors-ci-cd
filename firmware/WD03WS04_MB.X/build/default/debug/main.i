...
typedef struct
{
    ...
    uint16_t sensor_value1;
    uint16_t sensor_value2;
}input_register;
...
void main(void)
{
    ...
    while(1)
    {
        ...
        {
            registers.server_input_register.sensor_value1 = sensor1.sense(&sensor1.sensor_info.ADCChannel);
        }
         if(((_Bool) ((registers.server_coils.coils)[(0) / 8] & (0x1 << ((0) % 8)))) || ((_Bool) ((registers.server_coils.coils)[(2) / 8] & (0x1 << ((2) % 8)))))
        {
            registers.server_input_register.sensor_value2 = getCount();
        }
